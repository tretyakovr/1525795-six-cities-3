...
describe('test Favorites (FavoritesEmpty) component', () => {
  it('should contain "Nothing yet saved." in favorites page with authenticated user and empty favorite list', () => {
    const initialState = {
      [NameSpace.App]: {
        city: '',
  ...
  it('should contain "Saved listing" in favorites page with authenticated user and not empty favorite list', () => {
    const initialState = {
      [NameSpace.App]: {
        city: '',
        sortType: SortType.Popular,
