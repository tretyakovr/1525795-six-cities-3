...
describe('test Card component', () => {
  ...
  it('should contain Offer.title in offer card ', () => {
    initialState.OFFER.loadedOffers.map((item) => {
      const preparedComponent = withHistory(withStore(<Card offer={item} divClassName="cities__image-wrapper place-card__image-wrapper" />, initialState).withStoreComponent);
