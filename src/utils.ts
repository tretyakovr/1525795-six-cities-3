...
export function getSortedCityOffers(city: string | undefined, sortType: SortTypes): Offers {
  const cityOffers: Offers = [...store.getState().loadedOffers.filter((item) => item.city.name === city)];
